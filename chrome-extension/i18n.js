...
(() => {
  ...
  const MESSAGES = {
    en: {
      "job.transfer.average": "Average speed",
      "job.transfer.averageHint": "Speed is successful bytes divided by the time this stage had active requests; it is not an instantaneous rate.",
      "profile.expandShort": "Expand",
      "profile.collapseShort": "Collapse",
      "jobs.stale": "Could not update NAS jobs. Showing the last snapshot ({time}); retrying…",
      "jobs.unavailable": "Could not load NAS jobs. Retrying…",
      "jobs.unavailable.short": "Job list unavailable",
      "jobs.connectionFailed": "Job update failed",
      "jobs.invalidResponse": "Invalid response from the NAS jobs API.",
      "profile.collapse": "Collapse destination",
      "profile.expand": "Expand destination",
      "toolbar.quality": "Video quality",
      "profile.label": "Download destination · Profile",
      "profile.manage": "Manage",
      "profile.add": "Add profile",
      "profile.custom": "Current connection (custom)",
      "profile.empty": "No saved profiles",
      "profile.folder": "Save to {path}",
      "profile.setupHint": "Add a NAS connection to start downloading.",
      "profile.switching": "Switching profile…",
      "profile.switched": "Switched to {name}. New downloads use this destination.",
      "profile.failed": "Could not switch. Please try again.",
      ...
      'header.browserMode': 'BROWSER',
      'section.detectedVideos': 'Detected on this page',
      'section.recentDownloads': 'Recent on NAS',
      'toolbar.filter': 'filter…',
      'chip.all': 'all',
      'header.onPage': '{n} on page',
      'bulk.detected': '{n} detected',
      'bulk.selected': '{n} selected',
      'bulk.sendAll': 'Send all {n}',
      'bulk.sendSelected': 'Send selected ({n})',
      'bulk.sendDisabled': 'Select to send',
      'bulk.selectAll': 'Select all ({n})',
      'bulk.clearAll': 'Clear',
      'sort.time': 'newest',
      'sort.active': 'active first',
      'sort.failed': 'failed first',
      ...
      'url.nowPlaying.short': 'LIVE',
      'url.sendToNas': 'Send to NAS',
      'url.sentResend': 'Sent · click to send again',
      ...
      'job.browserMode.title': 'Downloaded in the browser session',
      'job.transfer.rate': 'CDN {cdn} / NAS {nas} MB/s',
      'job.transfer.stage.cdn': 'CDN',
      'job.transfer.stage.nas': 'NAS',
      'job.transfer.detail': '{stage}: {mb} MB successful / {attemptedMb} MB attempted · active {active}s · request time {request}s · requests {requests} · failures {failures} · in flight {inFlight} · cancelled {cancelled}',
      'job.transfer.concurrency': 'Concurrency: {concurrency}',
      'job.transfer.retryHint': 'Eligible failures are retried automatically.',
      ...
      'options.btn.testInline': 'test',
      'options.btn.testing': 'pinging…',
      'options.btn.show': 'show',
      'options.btn.hide': 'hide',
      'options.btn.copy': 'copy',
      'options.btn.copied': 'copied',
      'options.cmd.saveHint': 'save',
      'options.cmd.discardHint': 'discard',
      'options.cmd.autosaveHint': '↻ auto-saves on edit',
      'options.ping.idle': 'not tested',
      'options.ping.pinging': 'pinging…',
      'options.ping.unreachable': 'unreachable',
      'options.troubleshoot.s1': 'Check NAS is reachable on your network',
      'options.troubleshoot.s2': 'Verify API port (default 52052) is open',
      'options.troubleshoot.s3': 'API Key must match the value in NAS .env',
      'options.troubleshoot.s4': 'Allow the port through your firewall',
      'options.repo.openInBrowser': 'open in browser',
      'options.status.reverted': 'Reverted to saved values',
      'options.status.copyFailed': 'Copy failed',
      'options.profiles.defaultName': 'Default',
      'options.profiles.activate': 'activate',
      'options.profiles.activeMark': 'active',
      'options.profiles.delete': 'delete',
      'options.profiles.addBtn': '[profile.new] — save current as profile',
      'options.profiles.namePrompt': 'Name for this profile:',
      'options.profiles.fillFirst': 'Fill endpoint + api_key on connection.toml first',
      'options.profiles.confirmDelete': 'Delete profile "{name}"?',
      'options.profiles.deleted': 'Deleted "{name}"',
      'options.profiles.created': 'Saved profile "{name}"',
      'options.profiles.switched': 'Switched to "{name}"',
      'options.profiles.subdirHelp': '# subfolder under /downloads (blank = root)',
      'options.profiles.subdirPlaceholder': 'e.g. anime/work-safe',
      'options.profiles.subdirSaved': 'subdir saved',
      'options.profiles.subdirInvalid': 'Invalid subdir',
      ...
      'options.hiddenMode.help': 'Shows AV-task quick-input in the side panel',
      'options.hiddenModeUrlTemplate.help': 'URL pattern; {code} is replaced with the input',
      'options.hiddenMode.col.code': 'code',
      'options.hiddenMode.col.title': 'title',
      'options.hiddenMode.col.submitted': 'submitted',
      'options.hiddenMode.col.status': 'status',
      'options.hiddenMode.col.url': 'url',
      'options.hiddenMode.history.empty': 'no tasks yet — input a code in the side panel',
      'options.hiddenMode.history.clear': 'clear',
      'options.unsaved.suffix': 'unsaved',
      'av.title': 'AV task',
      'av.placeholder': 'nttr-015',
      'av.submit': 'Fetch',
      'av.status.pending': 'fetching…',
      'av.status.sent': 'sent',
      'av.status.failed': 'failed',
      'av.toast.invalidTemplate': 'URL template must contain {code}. Update it in Settings.',
      'av.toast.invalidCode': 'Code can only contain letters, digits, dot, dash, underscore.',
    ...
    'zh-TW': {
      "job.transfer.average": "平均速度",
      "job.transfer.averageHint": "速度以成功傳輸量除以該階段的活躍時間計算，並非即時速度。",
      "profile.expandShort": "展開",
      "profile.collapseShort": "收合",
      "jobs.stale": "無法更新 NAS 任務，顯示上次資料（{time}）；正在重試…",
      "jobs.unavailable": "無法取得 NAS 任務，正在重試…",
      "jobs.unavailable.short": "暫時無法取得下載清單",
      "jobs.connectionFailed": "任務更新失敗",
      "jobs.invalidResponse": "NAS 任務 API 回傳的資料格式不正確。",
      "profile.collapse": "收合下載目的地",
      "profile.expand": "展開下載目的地",
      "toolbar.quality": "影片畫質",
      "profile.label": "下載目的地 · Profile",
      "profile.manage": "管理",
      "profile.add": "新增 profile",
      "profile.custom": "目前連線（自訂）",
      "profile.empty": "尚未儲存 profile",
      "profile.folder": "儲存至 {path}",
      "profile.setupHint": "新增 NAS 連線，即可開始下載。",
      "profile.switching": "正在切換 profile…",
      "profile.switched": "已切換至 {name}，新下載將送往此目的地。",
      "profile.failed": "切換失敗，請重試。",
      'status.checking': '檢查中…',
      ...
      'btn.theme.title': '切換主題',
      'section.detectedVideos': '本頁偵測到的影片',
      'section.recentDownloads': 'NAS 近期下載',
      'toolbar.filter': '篩選…',
      'chip.all': '全部',
      'header.onPage': '本頁 {n} 部',
      'bulk.detected': '偵測到 {n} 部',
      'bulk.selected': '已選 {n} 部',
      'bulk.sendAll': '全部送出（{n}）',
      'bulk.sendSelected': '送出選取（{n}）',
      'bulk.sendDisabled': '請先選取',
      'bulk.selectAll': '全選（{n}）',
      'bulk.clearAll': '清除選取',
      'sort.time': '最新',
      'sort.active': '進行中優先',
      ...
      'url.nowPlaying': '正在播放',
      'url.nowPlaying.short': '直播',
      'url.sendToNas': '送到 NAS',
      'url.sentResend': '已送出 · 點一下再送一次',
      ...
      'job.cancel': '取消',
      'job.solution': '建議解法',
      'job.browserMode.title': '由瀏覽器工作階段下載',
      'job.transfer.rate': 'CDN {cdn} / NAS {nas} MB/s',
      'job.transfer.stage.cdn': '來源 CDN',
      'job.transfer.stage.nas': 'NAS 上傳',
      'job.transfer.detail': '{stage}：成功 {mb} MB／嘗試 {attemptedMb} MB · 活躍 {active} 秒 · 請求時間 {request} 秒 · 請求 {requests} · 失敗 {failures} · 進行中 {inFlight} · 已取消 {cancelled}',
      'job.transfer.concurrency': '並行數：{concurrency}',
      'job.transfer.retryHint': '符合條件的失敗會自動重試。',
      ...
      'options.btn.testInline': '測試',
      'options.btn.testing': '連線中…',
      'options.btn.show': '顯示',
      'options.btn.hide': '隱藏',
      'options.btn.copy': '複製',
      'options.btn.copied': '已複製',
      'options.cmd.saveHint': '儲存',
      'options.cmd.discardHint': '放棄',
      'options.cmd.autosaveHint': '↻ 編輯時自動儲存',
      'options.ping.idle': '尚未測試',
      'options.ping.pinging': '連線中…',
      'options.ping.unreachable': '無法連線',
      'options.troubleshoot.s1': '確認 NAS 在網路上可達',
      'options.troubleshoot.s2': '檢查 API port(預設 52052)是否開放',
      'options.troubleshoot.s3': 'API Key 必須與 NAS .env 內的值一致',
      'options.troubleshoot.s4': '允許 port 通過防火牆',
      'options.repo.openInBrowser': '在瀏覽器開啟',
      'options.status.reverted': '已還原為儲存的值',
      'options.status.copyFailed': '複製失敗',
      'options.profiles.defaultName': '預設',
      'options.profiles.activate': '啟用',
      'options.profiles.activeMark': '使用中',
      'options.profiles.delete': '刪除',
      'options.profiles.addBtn': '[profile.new] — 把目前設定存成新 profile',
      'options.profiles.namePrompt': '為此 profile 取個名稱:',
      'options.profiles.fillFirst': '請先在 connection.toml 填好 endpoint + api_key',
      'options.profiles.confirmDelete': '刪除 profile「{name}」?',
      'options.profiles.deleted': '已刪除「{name}」',
      'options.profiles.created': '已儲存 profile「{name}」',
      'options.profiles.switched': '已切換到「{name}」',
      'options.profiles.subdirHelp': '# /downloads 下的子資料夾（空白＝根目錄）',
      'options.profiles.subdirPlaceholder': '例如：anime/work-safe',
      'options.profiles.subdirSaved': '子資料夾已儲存',
      'options.profiles.subdirInvalid': '子資料夾格式錯誤',
      ...
      'options.hiddenMode.help': '在 Side Panel 顯示 AV 任務快速輸入',
      'options.hiddenModeUrlTemplate.help': '網址樣板,{code} 會被替換為輸入',
      'options.hiddenMode.col.code': '代碼',
      'options.hiddenMode.col.title': '標題',
      'options.hiddenMode.col.submitted': '送出時間',
      'options.hiddenMode.col.status': '狀態',
      'options.hiddenMode.col.url': '網址',
      'options.hiddenMode.history.empty': '目前無任務 — 在側欄輸入代碼即可',
      'options.hiddenMode.history.clear': '清空',
      'options.unsaved.suffix': '未儲存',
      'av.title': 'AV 任務',
      'av.placeholder': 'nttr-015',
      'av.submit': '取得',
      'av.status.pending': '抓取中…',
      'av.status.sent': '已送出',
      'av.status.failed': '失敗',
      'av.toast.invalidTemplate': '網址樣板必須包含 {code},請到設定頁修改。',
      'av.toast.invalidCode': '番號只能含英數字、點、連字號、底線。',
    ...
    'zh-CN': {
      "job.transfer.average": "平均速度",
      "job.transfer.averageHint": "速度以成功传输量除以该阶段的活跃时间计算，并非即时速度。",
      "profile.expandShort": "展开",
      "profile.collapseShort": "收起",
      "jobs.stale": "无法更新 NAS 任务，显示上次数据（{time}）；正在重试…",
      "jobs.unavailable": "无法获取 NAS 任务，正在重试…",
      "jobs.unavailable.short": "暂时无法获取下载列表",
      "jobs.connectionFailed": "任务更新失败",
      "jobs.invalidResponse": "NAS 任务 API 返回的数据格式不正确。",
      "profile.collapse": "收起下载目的地",
      "profile.expand": "展开下载目的地",
      "toolbar.quality": "视频画质",
      "profile.label": "下载目的地 · Profile",
      "profile.manage": "管理",
      "profile.add": "新增 profile",
      "profile.custom": "当前连接（自定义）",
      "profile.empty": "尚未保存 profile",
      "profile.folder": "保存至 {path}",
      "profile.setupHint": "新增 NAS 连接，即可开始下载。",
      "profile.switching": "正在切换 profile…",
      "profile.switched": "已切换至 {name}，新下载将发送至此目的地。",
      "profile.failed": "切换失败，请重试。",
      'status.checking': '检查中…',
      ...
      'job.cancel': '取消',
      'job.solution': '建议解法',
      'job.browserMode.title': '由浏览器会话下载',
      'job.transfer.rate': 'CDN {cdn} / NAS {nas} MB/s',
      'job.transfer.stage.cdn': '来源 CDN',
      'job.transfer.stage.nas': 'NAS 上传',
      'job.transfer.detail': '{stage}：成功 {mb} MB／尝试 {attemptedMb} MB · 活跃 {active} 秒 · 请求时间 {request} 秒 · 请求 {requests} · 失败 {failures} · 进行中 {inFlight} · 已取消 {cancelled}',
      'job.transfer.concurrency': '并发数：{concurrency}',
      'job.transfer.retryHint': '符合条件的失败会自动重试。',
      ...
      'options.hiddenMode.help': '在 Side Panel 显示 AV 任务快速输入',
      'options.hiddenModeUrlTemplate.help': '网址模板,{code} 会被替换为输入',
      'options.hiddenMode.col.code': '代码',
      'options.hiddenMode.col.title': '标题',
      'options.hiddenMode.col.submitted': '送出时间',
      'options.hiddenMode.col.status': '状态',
      'options.hiddenMode.col.url': '网址',
      'options.hiddenMode.history.empty': '目前无任务 — 在侧栏输入代码即可',
      'options.hiddenMode.history.clear': '清空',
      'options.unsaved.suffix': '未保存',
      'av.title': 'AV 任务',
      'av.placeholder': 'nttr-015',
      'av.submit': '获取',
      'av.status.pending': '抓取中…',
      'av.status.sent': '已发送',
      'av.status.failed': '失败',
      'av.toast.invalidTemplate': '网址模板必须包含 {code},请到设置页修改。',
      'av.toast.invalidCode': '番号只能含字母、数字、点、连字符、下划线。',
    ...
    ja: {
      "job.transfer.average": "平均速度",
      "job.transfer.averageHint": "速度は成功した転送量をこの段階の稼働時間で割った平均値で、瞬間速度ではありません。",
      "profile.expandShort": "開く",
      "profile.collapseShort": "閉じる",
      "jobs.stale": "NAS のタスクを更新できません。前回のデータ（{time}）を表示し、再試行中…",
      "jobs.unavailable": "NAS のタスクを取得できません。再試行中…",
      "jobs.unavailable.short": "タスク一覧を取得できません",
      "jobs.connectionFailed": "タスク更新に失敗",
      "jobs.invalidResponse": "NAS タスク API の応答形式が不正です。",
      "profile.collapse": "ダウンロード先を折りたたむ",
      "profile.expand": "ダウンロード先を展開",
      "toolbar.quality": "画質",
      "profile.label": "ダウンロード先 · Profile",
      "profile.manage": "管理",
      "profile.add": "追加",
      "profile.custom": "現在の接続（カスタム）",
      "profile.empty": "保存済みプロファイルなし",
      "profile.folder": "保存先 {path}",
      "profile.setupHint": "NAS 接続を追加してダウンロードを開始します。",
      "profile.switching": "切り替え中…",
      "profile.switched": "{name} に切り替えました。新しいダウンロードに適用されます。",
      "profile.failed": "切り替えできませんでした。再試行してください。",
      'status.checking': '確認中…',
      ...
      'job.cancel': 'キャンセル',
      'job.solution': '推奨対処',
      'job.browserMode.title': 'ブラウザーセッションでダウンロード',
      'job.transfer.rate': 'CDN {cdn} / NAS {nas} MB/s',
      'job.transfer.stage.cdn': 'CDN',
      'job.transfer.stage.nas': 'NAS',
      'job.transfer.detail': '{stage}: 成功 {mb} MB / 試行 {attemptedMb} MB · 稼働 {active}秒 · リクエスト時間 {request}秒 · リクエスト {requests} · 失敗 {failures} · 実行中 {inFlight} · キャンセル {cancelled}',
      'job.transfer.concurrency': '並列数: {concurrency}',
      'job.transfer.retryHint': '条件を満たす失敗は自動的に再試行されます。',
    ...
    ko: {
      "job.transfer.average": "평균 속도",
      "job.transfer.averageHint": "속도는 성공한 전송량을 해당 단계의 활성 시간으로 나눈 평균값이며 순간 속도가 아닙니다.",
      "profile.expandShort": "펼치기",
      "profile.collapseShort": "접기",
      "jobs.stale": "NAS 작업을 업데이트할 수 없습니다. 이전 데이터({time})를 표시하며 재시도 중…",
      "jobs.unavailable": "NAS 작업을 불러올 수 없습니다. 재시도 중…",
      "jobs.unavailable.short": "작업 목록을 불러올 수 없습니다",
      "jobs.connectionFailed": "작업 업데이트 실패",
      "jobs.invalidResponse": "NAS 작업 API 응답 형식이 잘못되었습니다.",
      "profile.collapse": "다운로드 대상 접기",
      "profile.expand": "다운로드 대상 펼치기",
      "toolbar.quality": "영상 화질",
      "profile.label": "다운로드 대상 · Profile",
      "profile.manage": "관리",
      "profile.add": "추가",
      "profile.custom": "현재 연결 (사용자 지정)",
      "profile.empty": "저장된 프로필 없음",
      "profile.folder": "저장 위치 {path}",
      "profile.setupHint": "NAS 연결을 추가하여 다운로드를 시작하세요.",
      "profile.switching": "프로필 전환 중…",
      "profile.switched": "{name}(으)로 전환했습니다. 새 다운로드에 적용됩니다.",
      "profile.failed": "전환하지 못했습니다. 다시 시도하세요.",
      ...
      'job.browserMode.title': '브라우저 세션에서 다운로드',
      'job.transfer.rate': 'CDN {cdn} / NAS {nas} MB/s',
      'job.transfer.stage.cdn': 'CDN',
      'job.transfer.stage.nas': 'NAS',
      'job.transfer.detail': '{stage}: 성공 {mb} MB / 시도 {attemptedMb} MB · 활성 {active}초 · 요청 시간 {request}초 · 요청 {requests} · 실패 {failures} · 진행 중 {inFlight} · 취소 {cancelled}',
      'job.transfer.concurrency': '동시 처리: {concurrency}',
      'job.transfer.retryHint': '조건을 충족하는 실패는 자동으로 재시도됩니다.',
    ...
    fr: {
      "job.transfer.average": "Vitesse moyenne",
      "job.transfer.averageHint": "La vitesse correspond aux octets transférés avec succès divisés par le temps actif de cette étape, et non à une vitesse instantanée.",
      "profile.expandShort": "Déplier",
      "profile.collapseShort": "Replier",
      "jobs.stale": "Impossible d’actualiser les tâches NAS. Dernières données ({time}) ; nouvelle tentative…",
      "jobs.unavailable": "Impossible de charger les tâches NAS. Nouvelle tentative…",
      "jobs.unavailable.short": "Liste des tâches indisponible",
      "jobs.connectionFailed": "Échec de l’actualisation",
      "jobs.invalidResponse": "Réponse incorrecte de l’API des tâches NAS.",
      "profile.collapse": "Réduire la destination",
      "profile.expand": "Développer la destination",
      "toolbar.quality": "Qualité vidéo",
      "profile.label": "Destination · Profil",
      "profile.manage": "Gérer",
      "profile.add": "Ajouter",
      "profile.custom": "Connexion actuelle (personnalisée)",
      "profile.empty": "Aucun profil enregistré",
      "profile.folder": "Dossier : {path}",
      "profile.setupHint": "Ajoutez une connexion NAS pour télécharger.",
      "profile.switching": "Changement de profil…",
      "profile.switched": "Profil {name} activé pour les prochains téléchargements.",
      "profile.failed": "Échec du changement. Réessayez.",
      ...
      'job.browserMode.title': 'Téléchargé dans la session du navigateur',
      'job.transfer.rate': 'CDN {cdn} / NAS {nas} MB/s',
      'job.transfer.stage.cdn': 'CDN',
      'job.transfer.stage.nas': 'NAS',
      'job.transfer.detail': '{stage} : {mb} Mo réussis / {attemptedMb} Mo tentés · actif {active} s · temps des requêtes {request} s · requêtes {requests} · échecs {failures} · en cours {inFlight} · annulées {cancelled}',
      'job.transfer.concurrency': 'Concurrence : {concurrency}',
      'job.transfer.retryHint': 'Les échecs admissibles sont automatiquement retentés.',
    ...
    es: {
      "job.transfer.average": "Velocidad media",
      "job.transfer.averageHint": "La velocidad es el volumen transferido correctamente dividido por el tiempo activo de esta etapa; no es una velocidad instantánea.",
      "profile.expandShort": "Expandir",
      "profile.collapseShort": "Contraer",
      "jobs.stale": "No se pueden actualizar las tareas del NAS. Últimos datos ({time}); reintentando…",
      "jobs.unavailable": "No se pueden cargar las tareas del NAS. Reintentando…",
      "jobs.unavailable.short": "Lista de tareas no disponible",
      "jobs.connectionFailed": "Error al actualizar tareas",
      "jobs.invalidResponse": "Respuesta no válida de la API de tareas del NAS.",
      "profile.collapse": "Contraer destino",
      "profile.expand": "Expandir destino",
      "toolbar.quality": "Calidad de vídeo",
      "profile.label": "Destino · Perfil",
      "profile.manage": "Gestionar",
      "profile.add": "Añadir",
      "profile.custom": "Conexión actual (personalizada)",
      "profile.empty": "No hay perfiles guardados",
      "profile.folder": "Guardar en {path}",
      "profile.setupHint": "Añade una conexión NAS para empezar a descargar.",
      "profile.switching": "Cambiando perfil…",
      "profile.switched": "Perfil {name} activado para las próximas descargas.",
      "profile.failed": "No se pudo cambiar. Inténtalo de nuevo.",
      ...
      'job.browserMode.title': 'Descargado en la sesión del navegador',
      'job.transfer.rate': 'CDN {cdn} / NAS {nas} MB/s',
      'job.transfer.stage.cdn': 'CDN',
      'job.transfer.stage.nas': 'NAS',
      'job.transfer.detail': '{stage}: {mb} MB correctos / {attemptedMb} MB intentados · activo {active} s · tiempo de solicitudes {request} s · solicitudes {requests} · fallos {failures} · en curso {inFlight} · canceladas {cancelled}',
      'job.transfer.concurrency': 'Concurrencia: {concurrency}',
      'job.transfer.retryHint': 'Los fallos aptos se reintentan automáticamente.',
    ...
    pt: {
      "job.transfer.average": "Velocidade média",
      "job.transfer.averageHint": "A velocidade é o volume transferido com sucesso dividido pelo tempo ativo desta etapa, não uma velocidade instantânea.",
      "profile.expandShort": "Expandir",
      "profile.collapseShort": "Recolher",
      "jobs.stale": "Não foi possível atualizar as tarefas do NAS. Últimos dados ({time}); tentando novamente…",
      "jobs.unavailable": "Não foi possível carregar as tarefas do NAS. Tentando novamente…",
      "jobs.unavailable.short": "Lista de tarefas indisponível",
      "jobs.connectionFailed": "Falha ao atualizar tarefas",
      "jobs.invalidResponse": "Resposta inválida da API de tarefas do NAS.",
      "profile.collapse": "Recolher destino",
      "profile.expand": "Expandir destino",
      "toolbar.quality": "Qualidade do vídeo",
      "profile.label": "Destino · Perfil",
      "profile.manage": "Gerir",
      "profile.add": "Adicionar",
      "profile.custom": "Ligação atual (personalizada)",
      "profile.empty": "Nenhum perfil guardado",
      "profile.folder": "Guardar em {path}",
      "profile.setupHint": "Adicione uma ligação NAS para começar a transferir.",
      "profile.switching": "A mudar de perfil…",
      "profile.switched": "Perfil {name} ativado para as próximas transferências.",
      "profile.failed": "Não foi possível mudar. Tente novamente.",
      ...
      'job.browserMode.title': 'Baixado na sessão do navegador',
      'job.transfer.rate': 'CDN {cdn} / NAS {nas} MB/s',
      'job.transfer.stage.cdn': 'CDN',
      'job.transfer.stage.nas': 'NAS',
      'job.transfer.detail': '{stage}: {mb} MB concluídos / {attemptedMb} MB tentados · ativo {active} s · tempo de requisições {request} s · requisições {requests} · falhas {failures} · em andamento {inFlight} · canceladas {cancelled}',
      'job.transfer.concurrency': 'Concorrência: {concurrency}',
      'job.transfer.retryHint': 'Falhas elegíveis são repetidas automaticamente.',
